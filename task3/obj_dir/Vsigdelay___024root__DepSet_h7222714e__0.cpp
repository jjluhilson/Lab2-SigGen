...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT__address1 = vlSelf->sigdelay__DOT__address1;
    vlSelf->__Vdly__sigdelay__DOT__address1 = ((IData)(vlSelf->rst)
                                                ? 0U
                                                : (0x1ffU 
                                                   & ((IData)(1U) 
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__myRam__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT__address1) 
                        - (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr) {
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__address1 = vlSelf->__Vdly__sigdelay__DOT__address1;
}
